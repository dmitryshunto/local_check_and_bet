...
import { get_book_names_from_market_name, get_odd_types_and_values_from_market, get_text_selection_and_condition,
         return_bet_object, transform_name_for_ui } from '../../../CommonFunctions/typed_functions'
            ...
            return (game: MyNetGameType) => {
                ...
                for (let kind_of_bet of my_net_kinds_of_bet) {
                    if (kind_of_bet in game) {
                        ...
                        const data = game[kind_of_bet] as MyNetPredictionKindOfBetType
...
const create_prediction_columns = () => {
    ...
    columns_names.forEach((name) => {
        ...
        if (name === 'Ex. res.' || name === 'Ex. tot.') width = 50
